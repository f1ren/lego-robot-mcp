...
Consider state before acting by asking questions such as: do you need to open the gripper, or is it already open? Do you need to lower the arm, or is it already on the ground? If you close the gripper to grab an object, is the object well located to be grabbed once the jaws close?
