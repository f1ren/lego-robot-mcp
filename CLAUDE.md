...
5. **Never drive or turn with the arm down.** The arm in a lowered position blocks wheel motion and causes the wheels to slide instead of move the robot. Always raise the arm before any `drive` or `drive_degrees` call.
