...
_PROMPT = (
    ...
    "GRIPPER STATE: only call the gripper 'open' when the jaws are wide-open (fully "
    "apart). A partially-open gripper is NOT 'open' — describe it as 'partially open' "
    "or 'closed', because a non-wide gripper may not be able to grab the object.\n"
